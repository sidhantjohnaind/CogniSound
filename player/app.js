...
async function cycleShuffleMode() {
    ...
    let modeMsg = "🔀 Shuffle Mode: Standard Random";
    if (nextMode === "ai") modeMsg = "📻 Shuffle Mode: Auto-DJ (Spotify/Deezer Flow Radio Stream)";
    else if (nextMode === "melody") modeMsg = "🪄 Shuffle Mode: Melody & Harmonic Twins";
    if (typeof showNotification === "function") showNotification(modeMsg);
